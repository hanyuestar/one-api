...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		logRoute.GET("/model-analysis", middleware.AdminAuth(), controller.GetLogsModelAnalysis)
		logRoute.GET("/self/model-analysis", middleware.UserAuth(), controller.GetLogsSelfModelAnalysis)
